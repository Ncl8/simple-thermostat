...
`;function ct(t,e,i,n={}){n=n||{},i=null==i?{}:i;const s=new Event(e,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});return s.detail=i,t.dispatchEvent(s),s}!function(t,e){void 0===e&&(e={});var i=e.insertAt;if(t&&"undefined"!=typeof document){var n=document.head||document.getElementsByTagName("head")[0],s=document.createElement("style");s.type="text/css","top"===i&&n.firstChild?n.insertBefore(s,n.firstChild):n.appendChild(s),s.styleSheet?s.styleSheet.cssText=t:s.appendChild(document.createTextNode(t))}}(at);const lt=[0,1],ht=[.5,1],dt=["column","row"],pt=["climate"],ut={header:{},layout:{mode:{}}};function ft(t,e,i,n){var s,r=arguments.length,o=r<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,n);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(o=(r<3?s(o):r>3?s(e,i,o):s(e,i))||o);return r>3&&o&&Object.defineProperty(e,i,o),o}"function"==typeof SuppressedError&&SuppressedError;const gt={attribute:!0,type:String,converter:y,reflect:!1,hasChanged:_},mt=(t=gt,e,i)=>{const{kind:n,metadata:s}=i;let r=globalThis.litPropertyMetadata.get(s);if(void 0===r&&globalThis.litPropertyMetadata.set(s,r=new Map),"setter"===n&&((t=Object.create(t)).wrapped=!0),r.set(i.name,t),"accessor"===n){const{name:n}=i;return{set(i){const s=e.get.call(this);e.set.call(this,i),this.requestUpdate(n,s,t)},init(e){return void 0!==e&&this.C(n,void 0,t,e),e}}}if("setter"===n){const{name:n}=i;return function(i){const s=this[n];e.call(this,i),this.requestUpdate(n,s,t)}}throw Error("Unsupported decorator location: "+n)};function vt(t){return(e,i)=>"object"==typeof i?mt(t,e,i):((t,e,i)=>{const n=e.hasOwnProperty(i);return e.constructor.createProperty(i,t),n?Object.getOwnPropertyDescriptor(e,i):void 0})(t,e,i)}const yt=(t,e,i,n)=>{if("length"===i||"prototype"===i)return;if("arguments"===i||"caller"===i)return;const s=Object.getOwnPropertyDescriptor(t,i),r=Object.getOwnPropertyDescriptor(e,i);!_t(s,r)&&n||Object.defineProperty(t,i,r)},_t=function(t,e){return void 0===t||t.configurable||t.writable===e.writable&&t.enumerable===e.enumerable&&t.configurable===e.configurable&&(t.writable||t.value===e.value)},$t=(t,e)=>`/* Wrapped ${t}*/\n${e}`,bt=Object.getOwnPropertyDescriptor(Function.prototype,"toString"),wt=Object.getOwnPropertyDescriptor(Function.prototype.toString,"name");function xt(t,e,{ignoreNonConfigurable:i=!1}={}){const{name:n}=t;for(const n of Reflect.ownKeys(e))yt(t,e,n,i);return((t,e)=>{const i=Object.getPrototypeOf(e);i!==Object.getPrototypeOf(t)&&Object.setPrototypeOf(t,i)})(t,e),((t,e,i)=>{const n=""===i?"":`with ${i.trim()}() `,s=$t.bind(null,n,e.toString());Object.defineProperty(s,"name",wt);const{writable:r,enumerable:o,configurable:a}=bt;Object.defineProperty(t,"toString",{value:s,writable:r,enumerable:o,configurable:a})})(t,e,n),t}const At=(t,e={})=>{if("function"!=typeof t)throw new TypeError(`Expected the first argument to be a function, got \`${typeof t}\``);const{wait:i=0,maxWait:n=Number.POSITIVE_INFINITY,before:s=!1,after:r=!0}=e;if(i<0||n<0)throw new RangeError("`wait` and `maxWait` must not be negative.");if(!s&&!r)throw new Error("Both `before` and `after` are false, function wouldn't be called.");let o,a,c;const l=function(...e){const l=this,h=()=>{a=void 0,o&&(clearTimeout(o),o=void 0),r&&(c=t.apply(l,e))},d=s&&!o;return clearTimeout(o),o=setTimeout(()=>{o=void 0,a&&(clearTimeout(a),a=void 0),r&&(c=t.apply(l,e))},i),n>0&&n!==Number.POSITIVE_INFINITY&&!a&&(a=setTimeout(h,n)),d&&(c=t.apply(l,e)),c};return xt(l,t),l.cancel=()=>{o&&(clearTimeout(o),o=void 0),a&&(clearTimeout(a),a=void 0)},l};function Et(t,{decimals:e=1,fallback:i="N/A"}={}){return null===t||""===t||["boolean","undefined"].includes(typeof t)?i:Number(t).toFixed(e)}function St({header:t,toggleEntityChanged:e,entity:i,openEntityPopover:n}){if(!1===t)return L;const s=i.attributes.hvac_action||i.state;let r=t.icon;"object"==typeof t.icon&&(r=r?.[s]??!1);const o=t?.name??!1;return F`
    <header>
      <div
        ...
        @click=${()=>n()}
      >
        ${function(t){return t?F` <ha-icon class="header__icon" .icon=${t}></ha-icon> `:L}(r)} ${function(t){return t?F`<h2 class="header__title">${t}</h2>`:L}(o)}
      </div>
  ...
  `}var Ot,Ct={exports:{}};function kt(){return Ot||(Ot=1,function(t){function e(t){var i,n,s=new Error(t);return i=s,n=e.prototype,Object.setPrototypeOf?Object.setPrototypeOf(i,n):i.__proto__=n,s}function i(t,i,n){var s=i.slice(0,n).split(/\n/),r=s.length,o=s[r-1].length+1;throw e(t+=" at line "+r+" col "+o+":\n\n  "+i.split(/\n/)[r-1]+"\n  "+Array(o).join(" ")+"^")}e.prototype=Object.create(Error.prototype,{name:{value:"Squirrelly Error",enumerable:!1}});var n=new Function("return this")().Promise,s=!1;try{s=new Function("return (async function(){}).constructor")()}catch(t){if(!(t instanceof SyntaxError))throw t}function r(t,e){return Object.prototype.hasOwnProperty.call(t,e)}function o(t,e,i){for(var n in e)r(e,n)&&(null==e[n]||"object"!=typeof e[n]||"storage"!==n&&"prefixes"!==n||i?t[n]=e[n]:t[n]=o({},e[n]));return t}var a=/^async +/,c=/`(?:\\[\s\S]|\${(?:[^{}]|{(?:[^{}]|{[^}]*})*})*}|(?!\${)[^\\`])*`/g,l=/'(?:\\[\s\w"'\\`]|[^\n\r'\\])*?'/g,h=/"(?:\\[\s\w"'\\`]|[^\n\r"\\])*?"/g,d=/[.*+\-?^${}()|[\]\\]/g;function p(t){return d.test(t)?t.replace(d,"\\$&"):t}function u(t,n){n.rmWhitespace&&(t=t.replace(/[\r\n]+/g,"\n").replace(/^\s+|\s+$/gm,"")),c.lastIndex=0,l.lastIndex=0,h.lastIndex=0;var s=n.prefixes,r=[s.h,s.b,s.i,s.r,s.c,s.e].reduce(function(t,e){return t&&e?t+"|"+p(e):e?p(e):t},""),o=new RegExp("([|()]|=>)|('|\"|`|\\/\\*)|\\s*((\\/)?(-|_)?"+p(n.tags[1])+")","g"),d=new RegExp("([^]*?)"+p(n.tags[0])+"(-|_)?\\s*("+r+")?\\s*","g"),u=0,f=!1;function g(e,s){var r,p={f:[]},g=0,m="c";function v(e){var s=t.slice(u,e),r=s.trim();if("f"===m)"safe"===r?p.raw=!0:n.async&&a.test(r)?(r=r.replace(a,""),p.f.push([r,"",!0])):p.f.push([r,""]);else if("fp"===m)p.f[p.f.length-1][1]+=r;else if("err"===m){if(r){var o=s.search(/\S/);i("invalid syntax",t,u+o)}}else p[m]=r;u=e+1}for("h"===s||"b"===s||"c"===s?m="n":"r"===s&&(p.raw=!0,s="i"),o.lastIndex=u;null!==(r=o.exec(t));){var y=r[1],_=r[2],$=r[3],b=r[4],w=r[5],x=r.index;if(y)"("===y?(0===g&&("n"===m?(v(x),m="p"):"f"===m&&(v(x),m="fp")),g++):")"===y?0===--g&&"c"!==m&&(v(x),m="err"):0===g&&"|"===y?(v(x),m="f"):"=>"===y&&(v(x),u+=1,m="res");else if(_)if("/*"===_){var A=t.indexOf("*/",o.lastIndex);-1===A&&i("unclosed comment",t,r.index),o.lastIndex=A+2}else"'"===_?(l.lastIndex=r.index,l.exec(t)?o.lastIndex=l.lastIndex:i("unclosed string",t,r.index)):'"'===_?(h.lastIndex=r.index,h.exec(t)?o.lastIndex=h.lastIndex:i("unclosed string",t,r.index)):"`"===_&&(c.lastIndex=r.index,c.exec(t)?o.lastIndex=c.lastIndex:i("unclosed string",t,r.index));else if($)return v(x),u=x+r[0].length,d.lastIndex=u,f=w,b&&"h"===s&&(s="s"),p.t=s,p}return i("unclosed tag",t,e),p}var m=function r(o,c){o.b=[],o.d=[];var l,h=!1,p=[];function m(t,e){t&&(t=function(t,e,i,n){var s,r;return"string"==typeof e.autoTrim?s=r=e.autoTrim:Array.isArray(e.autoTrim)&&(s=e.autoTrim[1],r=e.autoTrim[0]),(i||!1===i)&&(s=i),(n||!1===n)&&(r=n),"slurp"===s&&"slurp"===r?t.trim():("_"===s||"slurp"===s?t=String.prototype.trimLeft?t.trimLeft():t.replace(/^[\s\uFEFF\xA0]+/,""):"-"!==s&&"nl"!==s||(t=t.replace(/^(?:\n|\r|\r\n)/,"")),"_"===r||"slurp"===r?t=String.prototype.trimRight?t.trimRight():t.replace(/[\s\uFEFF\xA0]+$/,""):"-"!==r&&"nl"!==r||(t=t.replace(/(?:\n|\r|\r\n)$/,"")),t)}(t,n,f,e))&&(t=t.replace(/\\|'/g,"\\$&").replace(/\r\n|\n|\r/g,"\\n"),p.push(t))}for(;null!==(l=d.exec(t));){var v,y=l[1],_=l[2],$=l[3]||"";for(var b in s)if(s[b]===$){v=b;break}m(y,_),u=l.index+l[0].length,v||i("unrecognized tag type: "+$,t,u);var w=g(l.index,v),x=w.t;if("h"===x){var A=w.n||"";n.async&&a.test(A)&&(w.a=!0,w.n=A.replace(a,"")),w=r(w),p.push(w)}else if("c"===x){if(o.n===w.n)return h?(h.d=p,o.b.push(h)):o.d=p,o;i("Helper start and end don't match",t,l.index+l[0].length)}else if("b"===x){h?(h.d=p,o.b.push(h)):o.d=p;var E=w.n||"";n.async&&a.test(E)&&(w.a=!0,w.n=E.replace(a,"")),h=w,p=[]}else if("s"===x){var S=w.n||"";n.async&&a.test(S)&&(w.a=!0,w.n=S.replace(a,"")),p.push(w)}else p.push(w)}if(!c)throw e('unclosed helper "'+o.n+'"');return m(t.slice(u,t.length),!1),o.d=p,o}({f:[]},!0);if(n.plugins)for(var v=0;v<n.plugins.length;v++){var y=n.plugins[v];y.processAST&&(m.d=y.processAST(m.d,n))}return m.d}function f(t,e){var i=u(t,e),n="var tR='';"+(e.useWith?"with("+e.varName+"||{}){":"")+_(i,e)+"if(cb){cb(null,tR)} return tR"+(e.useWith?"}":"");if(e.plugins)for(var s=0;s<e.plugins.length;s++){var r=e.plugins[s];r.processFnString&&(n=r.processFnString(n,e))}return n}function g(t,e){for(var i=0;i<e.length;i++){var n=e[i][0],s=e[i][1];t=(e[i][2]?"await ":"")+"c.l('F','"+n+"')("+t,s&&(t+=","+s),t+=")"}return t}function m(t,e,i,n,s,r){var o="{exec:"+(s?"async ":"")+y(i,e,t)+",params:["+n+"]";return r&&(o+=",name:'"+r+"'"),s&&(o+=",async:true"),o+"}"}function v(t,e){for(var i="[",n=0;n<t.length;n++){var s=t[n];i+=m(e,s.res||"",s.d,s.p||"",s.a,s.n),n<t.length&&(i+=",")}return i+"]"}function y(t,e,i){return"function("+e+"){var tR='';"+_(t,i)+"return tR}"}function _(t,e){for(var i=0,n=t.length,s="";i<n;i++){var r=t[i];if("string"==typeof r)s+="tR+='"+r+"';";else{var o=r.t,a=r.c||"",c=r.f,l=r.n||"",h=r.p||"",d=r.res||"",p=r.b,u=!!r.a;if("i"===o){e.defaultFilter&&(a="c.l('F','"+e.defaultFilter+"')("+a+")");var f=g(a,c);!r.raw&&e.autoEscape&&(f="c.l('F','e')("+f+")"),s+="tR+="+f+";"}else if("h"===o)if(e.storage.nativeHelpers.get(l))s+=e.storage.nativeHelpers.get(l)(r,e);else{var y=(u?"await ":"")+"c.l('H','"+l+"')("+m(e,d,r.d,h,u);y+=p?","+v(p,e):",[]",s+="tR+="+g(y+=",c)",c)+";"}else"s"===o?s+="tR+="+g((u?"await ":"")+"c.l('H','"+l+"')({params:["+h+"]},[],c)",c)+";":"e"===o&&(s+=a+"\n")}}return s}var $=function(){function t(t){this.cache=t}return t.prototype.define=function(t,e){this.cache[t]=e},t.prototype.get=function(t){return this.cache[t]},t.prototype.remove=function(t){delete this.cache[t]},t.prototype.reset=function(){this.cache={}},t.prototype.load=function(t){o(this.cache,t,!0)},t}();function b(t,i,n,s){if(i&&i.length>0)throw e((s?"Native":"")+"Helper '"+t+"' doesn't accept blocks");if(n&&n.length>0)throw e((s?"Native":"")+"Helper '"+t+"' doesn't accept filters")}var w={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};function x(t){return w[t]}var A=new $({}),E=new $({each:function(t,e){var i="",n=t.params[0];if(b("each",e,!1),t.async)return new Promise(function(e){!function t(e,i,n,s,r){n(e[i],i).then(function(o){s+=o,i===e.length-1?r(s):t(e,i+1,n,s,r)})}(n,0,t.exec,i,e)});for(var s=0;s<n.length;s++)i+=t.exec(n[s],s);return i},foreach:function(t,e){var i=t.params[0];if(b("foreach",e,!1),t.async)return new Promise(function(e){!function t(e,i,n,s,r,o){s(i[n],e[i[n]]).then(function(a){r+=a,n===i.length-1?o(r):t(e,i,n+1,s,r,o)})}(i,Object.keys(i),0,t.exec,"",e)});var n="";for(var s in i)r(i,s)&&(n+=t.exec(s,i[s]));return n},include:function(t,i,n){b("include",i,!1);var s=n.storage.templates.get(t.params[0]);if(!s)throw e('Could not fetch template "'+t.params[0]+'"');return s(t.params[1],n)},extends:function(t,i,n){var s=t.params[1]||{};s.content=t.exec();for(var r=0;r<i.length;r++){var o=i[r];s[o.name]=o.exec()}var a=n.storage.templates.get(t.params[0]);if(!a)throw e('Could not fetch template "'+t.params[0]+'"');return a(s,n)},useScope:function(t,e){return b("useScope",e,!1),t.exec(t.params[0])}}),S=new $({if:function(t,e){b("if",!1,t.f,!0);var i="if("+t.p+"){"+_(t.d,e)+"}";if(t.b)for(var n=0;n<t.b.length;n++){var s=t.b[n];"else"===s.n?i+="else{"+_(s.d,e)+"}":"elif"===s.n&&(i+="else if("+s.p+"){"+_(s.d,e)+"}")}return i},try:function(t,i){if(b("try",!1,t.f,!0),!t.b||1!==t.b.length||"catch"!==t.b[0].n)throw e("native helper 'try' only accepts 1 block, 'catch'");var n="try{"+_(t.d,i)+"}",s=t.b[0];return n+"catch"+(s.res?"("+s.res+")":"")+"{"+_(s.d,i)+"}"},block:function(t,e){return b("block",t.b,t.f,!0),"if(!"+e.varName+"["+t.p+"]){tR+=("+y(t.d,"",e)+")()}else{tR+="+e.varName+"["+t.p+"]}"}}),O=new $({e:function(t){var e=String(t);return/[&<>"']/.test(e)?e.replace(/[&<>"']/g,x):e}}),C={varName:"it",autoTrim:[!1,"nl"],autoEscape:!0,defaultFilter:!1,tags:["{{","}}"],l:function(t,i){if("H"===t){var n=this.storage.helpers.get(i);if(n)return n;throw e("Can't find helper '"+i+"'")}if("F"===t){var s=this.storage.filters.get(i);if(s)return s;throw e("Can't find filter '"+i+"'")}},async:!1,storage:{helpers:E,nativeHelpers:S,filters:O,templates:A},prefixes:{h:"@",b:"#",i:"",r:"*",c:"/",e:"!"},cache:!1,plugins:[],useWith:!1};function k(t,e){var i={};return o(i,C),e&&o(i,e),t&&o(i,t),i.l.bind(i),i}function P(t,i){var n,r=k(i||{}),o=Function;if(r.async){if(!s)throw e("This environment doesn't support async/await");o=s}if(r.varName&&!1===(n=r.varName,/^[a-zA-Z_$][a-zA-Z0-9_$]*$/.test(n)))throw e("options.varName must be a valid JS identifier");try{return new o(r.varName,"c","cb",f(t,r))}catch(i){throw i instanceof SyntaxError?e("Bad template syntax\n\n"+i.message+"\n"+Array(i.message.length+1).join("=")+"\n"+f(t,r)):i}}function z(t,e){var i;return e.cache&&e.name&&e.storage.templates.get(e.name)?e.storage.templates.get(e.name):(i="function"==typeof t?t:P(t,e),e.cache&&e.name&&e.storage.templates.define(e.name,i),i)}C.l.bind(C),t.compile=P,t.compileScope=_,t.compileScopeIntoFunction=y,t.compileToString=f,t.defaultConfig=C,t.filters=O,t.getConfig=k,t.helpers=E,t.nativeHelpers=S,t.parse=u,t.render=function(t,i,s,r){var o=k(s||{});if(!o.async)return z(t,o)(i,o);if(!r){if("function"==typeof n)return new n(function(e,n){try{e(z(t,o)(i,o))}catch(t){n(t)}});throw e("Please provide a callback function, this env doesn't support Promises")}try{z(t,o)(i,o,r)}catch(t){return r(t)}},t.templates=A,Object.defineProperty(t,"__esModule",{value:!0})}(Ct.exports)),Ct.exports}var Pt=kt();const zt=2;class Tt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}class jt extends Tt{constructor(t){if(super(t),this.it=L,t.type!==zt)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===L||null==t)return this._t=void 0,this.it=t;if(t===D)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}jt.directiveName="unsafeHTML",jt.resultType=1;const Nt=(t=>(...e)=>({_$litDirective$:t,values:e}))(jt),Rt=t=>`<ha-icon icon="${t}"></ha-icon>`;function Ut(t,e){const{type:i,labels:n}=t?.layout?.sensors??{type:"table",labels:!0};return F` <div class="sensors ${[n?"with-labels":"without-labels","list"===i?"as-list":"as-table"].join(" ")}">${e}</div> `}function Ht({hide:t=!1,hass:e,state:i,details:n,localize:s,openEntityPopover:r}){if(t||void 0===i)return;const{type:o,heading:a,icon:c,unit:l,decimals:h}=n;let d;if(process.env.DEBUG&&console.log("ST: infoItem",{state:i,details:n}),"relativetime"===o)d=F`
  ...
  `}Pt.defaultConfig.autoEscape=!1,Pt.filters.define("icon",Rt),Pt.filters.define("join",(t,e=", ")=>t.join(e)),Pt.filters.define("css",(t,e)=>`<span style="${Object.entries(e).reduce((t,[e,i])=>`${t}${e}:${i};`,"")}">${t}</span>`),Pt.filters.define("debug",t=>{try{return JSON.stringify(t)}catch{return`Not able to read valid JSON object from: ${t}`}}),function(t){t.OFF="off",t.HEAT="heat",t.COOL="cool",t.HEAT_COOL="heat_cool",t.AUTO="auto",t.DRY="dry",t.FAN_ONLY="fan_only"}(It||(It={}));const Vt={auto:"mdi:radiator",cooling:"mdi:snowflake",fan:"mdi:fan",heating:"mdi:radiator",idle:"mdi:radiator-disabled",off:"mdi:radiator-off"},Ft={auto:"hass:autorenew",cool:"hass:snowflake",dry:"hass:water-percent",fan_only:"hass:fan",heat_cool:"hass:autorenew",heat:"hass:fire",off:"hass:power"};function Dt(t,e){const i=e.states[t.entity];let n="";return n=!0===t?.name?i.attributes.name:t?.name??"",{entity:i,label:n}}function Lt(t,e){return Array.isArray(t)?t.map(({entity:t,...i})=>({...i,state:e.states[t],entity:t})):[]}var Bt;!function(t){t.HVAC="hvac",t.FAN="fan",t.PRESET="preset",t.SWING="swing"}(Bt||(Bt={}));const Wt=Object.values(Bt),qt=[Bt.HVAC,Bt.PRESET],Jt="hass:chevron-up",Yt="hass:chevron-down",Zt="mdi:plus",Gt="mdi:minus",Kt={temperature:!1,state:!1};function Qt(t,e,i={}){return e[`${t}_modes`].filter(t=>function(t,e){if("object"==typeof e[t])return!1!==e[t].include;return e?.[t]??!0}(t,i)).map(t=>{const e="object"==typeof i[t]?i[t]:{};return{icon:Ft[t],value:t,name:t,...e}})}class Xt extends rt{constructor(){super(...arguments),this.modes=[],this._hass={},this.sensors=[],this.showSensors=!0,this.name="",this.stepSize=.5,this._values={},this._updatingValues=!1,this._hide=Kt,this._debouncedSetTemperature=At(t=>{const{domain:e,service:i,data:n={}}=this.service;this._hass.callService(e,i,{entity_id:this.config.entity,...n,...t})},{wait:500}),this.localize=(t,e="")=>{const i=`${e}${t}`;return this._hass?.localize?.(i)||t},this.toggleEntityChanged=t=>{if(!this.header||!this?.header?.toggle)return;const e=t.target;this._hass.callService("homeassistant",e.checked?"turn_on":"turn_off",{entity_id:this.header?.toggle?.entity?.entity_id})},this.setMode=(t,e)=>{t&&e?(this._hass.callService("climate",`set_${t}_mode`,{entity_id:this.config.entity,[`${t}_mode`]:e}),ct(this,"haptic","light")):ct(this,"haptic","failure")},this.openEntityPopover=(t=null)=>{ct(this,"hass-more-info",{entityId:t||this.config.entity})}}static get styles(){return at}static getConfigElement(){return window.document.createElement(`${t}-editor`)}setConfig(t){this.config={decimals:1,...t}}updated(){super.connectedCallback();const t=Array.from(this.renderRoot.querySelectorAll("[with-hass]"));for(const e of Array.from(t))Array.from(e.attributes).forEach(t=>{t.name.startsWith("fwd-")&&(e[t.name.replace("fwd-","")]=t.value)}),e.hass=this._hass}set hass(t){if(!this.config?.entity)return;const e=t.states[this.config.entity];if(!e)return;this._hass=t,this.entity!==e&&(this.entity=e),this.header=function(t,e,i){if(!1===t)return!1;let n;n="string"==typeof t?.name?t.name:!1!==t?.name&&e.attributes.friendly_name;let s=e.attributes.hvac_action?Vt:Ft;return void 0!==t?.icon&&(s=t.icon),{name:n,icon:s,toggle:t?.toggle?Dt(t.toggle,i):null,faults:Lt(t?.faults,i)}}(this.config.header,e,t),this.service=(this.config?.service??!1)||{domain:"climate",service:"set_temperature"};const i=e.attributes;let n=function(t,e){if(!1===t)return{};if(t)return Object.keys(t).reduce((i,n)=>{const s=t[n];return s?.hide?i:{...i,[n]:e?.[n]}},{});const i=function(t){return"number"==typeof t.target_temp_high&&"number"==typeof t.target_temp_low?"dual":"single"}(e);return"dual"===i?{target_temp_low:e.target_temp_low,target_temp_high:e.target_temp_high}:{temperature:e.temperature}}(this.config?.setpoints??null,i);this._updatingValues&&function(t,e){const i=Object.keys(t);return i.length===Object.keys(e).length&&!i.some(i=>t?.[i]!==e?.[i])}(n,this._values)?this._updatingValues=!1:this._updatingValues||(this._values=n);const s=t=>Wt.includes(t)&&i[`${t}_modes`],r=t=>t.filter(s).map(t=>({type:t,hide_when_off:!1,list:Qt(t,i)}));let o=[];if(!1===this.config.control)o=[];else if(Array.isArray(this.config.control))o=r(this.config.control);else if("object"==typeof this.config.control){const t=Object.entries(this.config.control);o=t.length>0?t.filter(([t])=>s(t)).map(([t,e])=>{const{_name:n,_hide_when_off:s,...r}=e;return{type:t,hide_when_off:s,name:n,list:Qt(t,i,r)}}):r(qt)}else o=r(qt);if(this.modes=o.map(t=>{if(t.type===Bt.HVAC){const i=[],n=Object.values(It);return t.list.forEach(t=>{const e=n.indexOf(t.value);i[e]=t}),{...t,list:i,mode:e.state}}const n=i[`${t.type}_mode`];return{...t,mode:n}}),this.config.step_size&&(this.stepSize=+this.config.step_size),this.config.hide&&(this._hide={...this._hide,...this.config.hide}),!1===this.config.sensors)this.showSensors=!1;else if(3===this.config.version){this.sensors=[];const t=this.config.sensors.map((t,e)=>{const i=t?.entity??this.config.entity;let n=this.entity;return t?.entity&&(n=this._hass.states[t.entity]),{id:t?.id??String(e),label:t?.label,template:t.template,show:!1!==t?.show,entityId:i,context:n}}),e=t.map(t=>t.id),i=[];e.includes("state")||i.push({id:"state",label:"{{ui.operation}}",template:"{{state.text}}",entityId:this.config.entity,context:this.entity}),e.includes("temperature")||i.push({id:"temperature",label:"{{ui.currently}}",template:"{{current_temperature|formatNumber}}",entityId:this.config.entity,context:this.entity}),this.sensors=[...i,...t]}else this.config.sensors&&(this.sensors=this.config.sensors.map(({name:e,entity:i,attribute:n,unit:s="",...r})=>{let o;const a=[e];return i?(o=t.states[i],a.push(o?.attributes?.friendly_name),n&&(o=o.attributes[n])):n&&n in this.entity.attributes&&(o=this.entity.attributes[n],a.push(n)),a.push(i),{...r,name:a.find(t=>!!t),state:o,entity:i,unit:s}}))}render({_hide:t,_values:e,_updatingValues:i,config:n,entity:s}=this){if(!n)return F``;const r=[];if(this.stepSize<1&&0===n.decimals&&r.push(F`
      ...
      `;const{attributes:{min_temp:o=null,max_temp:a=null,hvac_action:c}}=s,l=this.getUnit(),h=this.config?.layout?.step??"column",d="row"===h,p=[!this.header&&"no-header",c].filter(t=>!!t);let u;return 3===this.config.version?(u=this.sensors.filter(t=>!1!==t.show).map(t=>function({context:t,entityId:e,template:i="{{state.text}}",label:n,hass:s,variables:r={},config:o,localize:a,openEntityPopover:c}){const{state:l,attributes:h}=t,[d]=e.split("."),p=s.selectedLanguage||s.language,u="ui.card.climate.",f=Object.entries(s.resources?.[p]??{}).reduce((t,[e,i])=>(e.startsWith(u)&&(t[e.replace(u,"")]=i),t),{}),g={...h,state:{raw:l,text:a(l,`component.${d}.state._.`)},ui:f,v:r};Pt.filters.define("formatNumber",(t,e={decimals:o.decimals})=>String(Et(t,e))),Pt.filters.define("relativetime",(t,e={})=>`<ha-relative-time fwd-datetime=${t} with-hass></ha-relative-time>`),Pt.filters.define("translate",(t,e="")=>a(t,e||"climate"!==d&&"humidifier"!==d?e:`state_attributes.${d}.${t}`));const m=t=>Pt.render(t,g,{useWith:!0}),v=m(i);if(!1===n||!1===o?.layout?.sensors?.labels)return F`<div class="sensor-value">${Nt(v)}</div>`;const y=n||"{{friendly_name}}",_=y.match(/^(mdi|hass):.*/)?Rt(y):m(y);return F`
    <div class="sensor-heading">${Nt(_)}</div>
    <div class="sensor-value">${Nt(v)}</div>
  `}({...t,variables:this.config.variables,hass:this._hass,config:this.config,localize:this.localize,openEntityPopover:this.openEntityPopover})),u=Ut(this.config,u)):u=this.showSensors?function({_hide:t,entity:e,unit:i,hass:n,sensors:s,config:r,localize:o,openEntityPopover:a}){const{state:c,attributes:{hvac_action:l,current_temperature:h}}=e,d=r?.layout?.sensors?.labels??!0;let p=o(c,"component.climate.state._.");l&&(p=[o(l,"state_attributes.climate.hvac_action."),` (${p})`].join(""));const u=[Ht({hide:t.temperature,state:`${Et(h,r)}${i||""}`,hass:n,details:{heading:!!d&&(r?.label?.temperature??o("ui.card.climate.currently"))}}),Ht({hide:t.state,state:p,hass:n,details:{heading:!!d&&(r?.label?.state??o("ui.panel.lovelace.editor.card.generic.state"))}}),...s.map(({name:t,state:e,...i})=>Ht({state:e,hass:n,localize:o,openEntityPopover:a,details:{...i,heading:d&&t}}))||null].filter(t=>null!==t);return Ut(r,u)}({_hide:this._hide,unit:l,hass:this._hass,entity:this.entity,sensors:this.sensors,config:this.config,localize:this.localize,openEntityPopover:this.openEntityPopover}):"",F`
